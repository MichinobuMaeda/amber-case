...
describe('MyEmailPanel', () => {
  ...
  it('enables button if data is valid and is modified.', async () => {
    ...
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'a');
    expect(screen.getByText(comfermationMassage)).toBeInTheDocument();
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), '{backspace}');
    expect(screen.getByText(requiredMessage)).toBeInTheDocument();
    expect(screen.queryByText(comfermationMassage)).toBeNull();
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'a');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'b');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'c');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), '@');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'd');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'e');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'f');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), '.');
    ...
    userEvent.type(screen.queryByLabelText(i18n.t('Confirmation')), '.');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'g');
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'h');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();
    userEvent.type(screen.queryByLabelText(i18n.t('Confirmation')), 'g');
    userEvent.type(screen.queryByLabelText(i18n.t('Confirmation')), 'h');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'i');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();
    ...
    userEvent.type(screen.queryByLabelText(i18n.t('New E-mail')), 'j');
