...
describe('MyPasswordPanel', () => {
  ...
  it('enables button if data is valid and is modified.', async () => {
    ...
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), 'T');
    ...
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), 'e');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), 's');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), 't');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '1');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '2');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '3');
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '4');

    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), 'T');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), 'e');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), 's');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), 't');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '1');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '2');
    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '3');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();

    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '4');
    await waitFor(() => expect(screen.queryByText(requiredMessage)).toBeNull());
    expect(screen.queryByText(comfermationMassage)).toBeNull();
    ...
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '5');
    expect(screen.queryByText(successMessage)).toBeNull();
    expect(screen.queryByText(errorMessage)).toBeNull();
  ...
  it('disables button if data is invalid.', async () => {
    ...
    userEvent.type(screen.getByLabelText(`${i18n.t('Password')}`), '{backspace}');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();

    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '{backspace}');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();

    userEvent.type(screen.getByLabelText(`${i18n.t('Confirmation')}`), '5');
    expect(screen.queryByRole('button', { name: 'save' })).toBeDisabled();
