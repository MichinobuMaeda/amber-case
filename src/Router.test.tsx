...
describe('Router', () => {
  ...
  it('shows EmailVerificationPage as the top page if the status is pending.', () => {
    mockContext.conf = { id: 'conf' } as Conf;
    mockContext.authUser = { uid: 'id01', email: 'id01@example.com' } as User;
    mockContext.me = { id: 'id01', valid: true, name: 'User 01' } as Account;
    render(
      <AppContext.Provider value={mockContext}>
        <MemoryRouter initialEntries={['/']}>
          <Router />
  ...
  it('shows HomePage as the top page if the status is user.', () => {
    mockContext.conf = { id: 'conf' } as Conf;
    mockContext.authUser = { uid: 'id01', email: 'id01@example.com', emailVerified: true } as User;
    mockContext.me = { id: 'id01', valid: true, name: 'User 01' } as Account;
    render(
      <AppContext.Provider value={mockContext}>
        <MemoryRouter initialEntries={['/']}>
